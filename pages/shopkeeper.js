...
`;
  ...
  const payWithUPI = async () => {
    ...
    setTimeout(async () => {
      ...
      alert("✅ Order Created (UPI Payment)");

    }, 5000);
  };

  // ============================
  // 🔥 BANK / RAZORPAY PAYMENT
  // ============================
...
const card={ background:"white", padding:"35px", borderRadius:"20px", width:"430px" };
const title={ textAlign:"center", fontSize:"30px" };
const input={ width:"100%", padding:"12px", marginBottom:"12px", borderRadius:"10px" };
const textarea={ width:"100%", padding:"12px", minHeight:"70px" };
const row={ display:"flex", justifyContent:"space-between" };
const halfInput={ width:"48%", padding:"12px" };
const productBtn={ width:"100%", padding:"12px", background:"#ff9800", color:"white" };
const locationButton={ width:"100%", padding:"10px", background:"#2962ff", color:"white" };
const submitBtn={ width:"100%", padding:"14px", background:"#00c853", color:"white" };
...
const popup={ background:"white", padding:"25px", borderRadius:"15px" };
